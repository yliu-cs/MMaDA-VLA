...
class MMaDA_VLA_Server(object):
    ...
    def rl_inference(
        ...
        with torch.autocast("cuda", dtype=torch.bfloat16):
            ...
            action = self.decode_action(output.action_sequences)
        return merged_image_tokens, output, action

    def batch_rl_inference(
        self,
        task_insts: List[str],
        images: List[Union[np.ndarray, Image.Image]],
        gripper_images: List[Union[np.ndarray, Image.Image]],
        ...
        with torch.autocast("cuda", dtype=torch.bfloat16):
            ...
            actions = self.decode_action(output.action_sequences)
        return merged_image_tokens, output, actions