...
class DataArguments:
    ...
    data_path: str = field(default=os.path.join(os.sep, "liuyang", "Dataset", "RoLD"))
...
def main() -> None:
    ...
    training_args.output_dir = f"{training_args.output_dir}_{data_args.n_steps}steps"
    ...
    dataset = ActionDataset(data_path=os.path.join(data_args.data_path, f"{data_args.n_steps}steps_action.npy"))
